...
- (2x + 3y = 10)
- (4x - y = 5)
Berdasarkan buku Sistem Persamaan Linear Tiga Variabel untuk Kelas X SMA/MA, Amalia Restu Aninda, dkk, 2021, tujuan utama dalam menyelesaikan sistem persamaan linear adalah menemukan nilai-nilai variabel yang memenuhi semua persamaan dalam sistem tersebut. Nilai ini disebut sebagai solusi dari sistem persamaan linear.

## Fungsi sistem persamaan linear
Dalam matematika, sistem persamaan linear memiliki fungsi untuk memodelkan masalah masukan-keluaran atau hubungan linier antara variabel-variabel tertentu. Bisa juga untuk menyelesaikan berbagai masalah pemrograman yang melibatkan pengoptimalan sumber daya.

Sistem persamaan linear juga digunakan untuk menyelesaikan berbagai masalah matematika. Seperti masalah geometri, fisika, atau ekonomi. Misalnya, dalam geometri, sistem persamaan linear dapat digunakan untuk menemukan titik perpotongan antara dua garis.

Pada penerapan masalah optimasi, saat tujuan utamanya adalah memaksimalkan atau meminimalkan fungsi objektif tertentu, sistem ini juga dapat difungsikan. Inilah yang biasanya dikenal sebagai masalah pemrograman linier.
...
- Koefisien
Koefisien adalah suatu bilangan yang dapat menjelaskan banyaknya jumlah variabel sejenis. Keberadaan koefisien sendiri akan berada di depan variable.
